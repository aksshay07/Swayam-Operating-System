...
bpbOEM			db "Swayam OS "				; This member must be exactally 8 bytes. It is just
...
msg	db	"Welcome to Swayam Operating System!", 0		; the string to print
